...
test_data$phat <- predict(modelo_2021s, newdata = test_data, type = "response")

# Classificar como 0 ou 1 com um cutoff de 0.5
test_data$pred_class <- ifelse(test_data$phat > 0.1, 1, 0)
# cutoff de 0,1 assim como no algoritmo de rna
